...
use db\Contact as ChildContact;
use db\ContactQuery as ChildContactQuery;
use \Exception;
use \PDO;
use db\Map\ContactTableMap;
 ...
 * @method     ChildContactQuery orderBySurname($order = Criteria::ASC) Order by the surname column
 ...
 * @method     ChildContactQuery groupBySurname() Group by the surname column
 ...
 * @method     ChildContact findOneBySurname(string $surname) Return the first ChildContact filtered by the surname column
 ...
 * @method     ChildContact requireOneBySurname(string $surname) Return the first ChildContact filtered by the surname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildContact[]|ObjectCollection findBySurname(string $surname) Return ChildContact objects filtered by the surname column
...
abstract class ContactQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, surname, email, created_at, updated_at FROM contact WHERE id = :p0';
        try {
    ...
    public function filterBySurname($surname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContactTableMap::COL_SURNAME, $surname, $comparison);
    }
