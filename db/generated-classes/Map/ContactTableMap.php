...
class ContactTableMap extends TableMap
{
     ...
     */
    const COL_SURNAME = 'contact.surname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Surname', 'Email', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'surname', 'email', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID, ContactTableMap::COL_NAME, ContactTableMap::COL_SURNAME, ContactTableMap::COL_EMAIL, ContactTableMap::COL_CREATED_AT, ContactTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'surname', 'email', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Surname' => 2, 'Email' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'surname' => 2, 'email' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ContactTableMap::COL_ID => 0, ContactTableMap::COL_NAME => 1, ContactTableMap::COL_SURNAME => 2, ContactTableMap::COL_EMAIL => 3, ContactTableMap::COL_CREATED_AT => 4, ContactTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'surname' => 2, 'email' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactTableMap::COL_SURNAME);
